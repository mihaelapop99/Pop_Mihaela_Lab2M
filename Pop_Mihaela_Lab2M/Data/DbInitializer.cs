...
namespace Pop_Mihaela_Lab2M.Data
{
    ...
    public static void Initialize(LibraryContext context)
     ...
     new Customer{CustomerID=1050,Name="Popescu
    Marcela",BirthDate=DateTime.Parse("1979-09-01")},
     new Customer{CustomerID=1045,Name="Mihailescu
    Cornel",BirthDate=DateTime.Parse("1969-07-08")},
